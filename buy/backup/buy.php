...
<body>
    ...
    <div class="col-md-12">
        <div class="box">
            <h1>Shop</h1>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Commodi corrupti facere ea libero quos, voluptas itaque distinctio, harum, maxime ut excepturi atque. Maxime officiis neque possimus ex, debitis similique modi!</p>
        </div>
        <div class="row">
        <?php
        ...
        ?>
            <div class="col-md-4 col-sm-6 center responsive">
                <div class="product">
                    ...
                    <button type="button" class="btn bg-cart" id="button">Buy Now</button>
