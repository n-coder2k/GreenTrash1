...
<body>
    ...
    <div class="container-fluid p-5 mb-2 user">
        ...
        <p><button type="button" class="btn bg-cart" id="button" ><a href="detail.php" id="link">View Order Details</a></button></p>
    ...
    <!-- DEMO 4 -->
  <div class="container2 pb-5 pt-2" id="main">
     ...
     <div class="container text-light ">
      <div class="row justify-content-evenly">
          ...
          <div class="col-md-6 p-5">
              <h1 class="text-uppercase" style="color:black;">Buy waste</h1>
              ...
              <button class="btn btn-success w-75" id="button"><a href="../../buy/n.php" class="btns" id="link">Buy Trash</a></button>            
          </div>
      </div>
  </div>
