        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
             ...
             ?>
             <button class="btn btn-primary my-2"><a href="selldata.php" class="text-light" style="text-decoration:none">Detailed Sell Summary</a></button>
              </div>
            </div>
        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
             ...
             ?>
              <button class="btn btn-primary my-2"><a href="buydata.php" class="text-light" style="text-decoration:none">Detailed Buy Summary</a></button>
              </div>
            </div>
