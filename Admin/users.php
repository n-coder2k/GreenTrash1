...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">User's Details</h1>
        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              echo "<h4>Trash Sellers: $rowcount</h4>"
             ?>
             <button class="btn btn-primary my-2"><a href="sellertable.php" class="text-light" style="text-decoration:none">Detailed Sell Summary</a></button>
              </div>
            </div>
        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              echo "<h4>Trash Buyers: $rowcount</h4>"
             ?>
              <button class="btn btn-primary my-2"><a href="buyertable.php" class="text-light" style="text-decoration:none">Detailed Buy Summary</a></button>
              </div>
            </div>
